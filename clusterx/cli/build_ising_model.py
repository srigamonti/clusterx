...
@plac.annotations(
    suffix=("Suffix to be added to the file names created by this command", "option", None, str),
    prefix=("Prefix to be added to the file names created by this command", "option", None, str),
    true3d=("By default 2D Ising model is built. Put this to true for 3D Ising model", "flag", "t3d", bool),
)
def build_ising_model(suffix: str = "", prefix: str = "", true3d: bool = False):
    ...
    cpool = ClustersPool(parent_lattice=plat, npoints=[2], radii=[1.1], super_cell=scell)
    cpool.gen_clusters()
