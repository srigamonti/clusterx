...
@pytest.mark.xfail(raises=AssertionError, reason="Reference values need to be updated")
def test_clusters_selector_compare_ref():
    ...
    rrmse = np.array(
        [
            ...
            3.9993762570864715,
            3.999376257086461,
            1.3982627586177953e-12,
            2.458069680489386e-13,
            3.9889575076243714e-13,
            1.1566745888836136e-12,
            4.3970985792892635e-13,
            4.630264154207033e-13,
        ]
    )
    rcvs = np.array(
        [
