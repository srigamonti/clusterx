...
def test_2D_radii():
    ...
    mult_ref = np.array([
        1, 1, 1, 1, 1, 1, 1, 2, 1, 2, 2, 1, 1, 2, 1, 1, 1, 2, 2,
...
def test_2D_supercell():
    ...
    mult_ref = np.array(
        [2, 2, 2, 1, 2, 2, 4, 2, 2, 2, 2, 4, 4, 2, 4, 1, 2, 2])
    npoints_ref = np.array(
        [1, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2])
    radii_ref = np.array([
        0.      ,  0.      ,  3.      ,  3.      ,  3.      ,  3.      ,
        4.242641,  4.242641,  6.      ,  6.      ,  6.      ,  6.708204,
        6.708204,  6.708204,  8.485281,  9.      ,  9.486833, 10.816654])
...
def test_fcc_radii():
    ...
    radii_ref = np.array([0., 2.8991378, 4.1, 2.8991378, 4.1])
...
def test_pt_111():
    ...
    mult_ref = np.array([
        1, 1, 1, 3, 3, 3, 3, 3, 3, 3, 3, 3, 6, 3, 3,
        6, 6, 3, 1, 1, 6, 1, 6, 6, 6])
    npoints_ref = np.array([
        1, 1, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 3, 3, 3, 3,
        3, 3, 3, 3, 3, 3, 3, 3, 3])
    radii_ref = np.array([
        0.        , 0.        , 0.        , 1.60805243, 1.60805243,
        1.60810181, 2.78520012, 2.78520012, 2.78520012, 3.21608028,
        3.21608028, 3.21610496, 1.60810181, 2.78520012, 2.78520012,
...
def test_clathrate():
    ...
    mult_ref = np.array(
        [24, 16,  6,  8, 48, 12, 24, 24, 48, 48, 48, 48, 48, 12, 24])
    npoints_ref = np.array([1, 1, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2])
    radii_ref = np.array([
        0.      , 0.      , 0.      , 2.367582, 2.424043,
        2.439434, 2.496507, 3.890476, 3.901473, 3.919454,
        3.920018, 3.951327, 4.054079, 4.121802, 4.365504])
